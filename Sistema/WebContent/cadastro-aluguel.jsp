...
<html lang="en">
 ...
 <div class="container-fluid">
 	...
 	<form class="form-horizontal" method ="Post" action="CadastrarAluguel">
		   ...
		   <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="id_funcionario" name="id_funcionario" placeholder="ID Funcionario">
		  </div>
		   <div class="form-group">
		    <label for="Id Automovel">Id Automovel</label>
		    <input type="text" class="form-control" id="id_automovel" name="id_automovel" placeholder="ID Automovel">
		  </div>
		   <div class="form-group">
